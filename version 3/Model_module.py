...
class Model_module:
    ...
    def load_model(self):
        ...
        # self.multiple_xgbclassification = pickle.load(open('model/Lightgbm_max_depth_15.h5', 'rb')) # multiclassova
        self.multiple_xgbclassification = pickle.load(open('model/Lightgbm_max_depth_feature_137_200825.h5', 'rb')) # multiclassova
        # self.multiple_xgbclassification = pickle.load(open('model/Lightgbm_max_depth_15_rev1.h5', 'rb')) # multiclass
        ...
        self.ab_21_02_lstmautoencoder = load_model('model/ab21-02_epoch200_[0.01140293]_acc_[0.8144184191122964]_rev1.h5')
        ...
        self.ab_19_02_lstmautoencoder = load_model('model/ab19-02_epoch200_[0.00610265]_acc_[0.8852787664918006]_rev1.h5')
    ...
    def train_untrain_classifier(self, data):
        ...
        return self.train_untrain_reconstruction_error, train_untrain_error
    ...
    def abnormal_procedure_verification(self, data): # 만약 abnormal 예측이 실패한다면??
        ...
        return self.abnormal_verif_reconstruction_error, verif_threshold, self.abnormal_verif_error
